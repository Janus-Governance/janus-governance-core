...
Janus Governance Core defines stack-agnostic specifications for systems that require traceable decisions, explicit evidence handling, and audit-ready records.
